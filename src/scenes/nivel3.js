export default class nivel3 extends Phaser.Scene {
    ...
    create() {
      ...
      this.physics.add.collider(this.enemys, plataformaLayer);
    this.physics.add.collider(
      this.jugador,
      this.enemys,
      this.enemyKill,
    ...
    esVencedor(jugador, salida) {
      ...
      console.log("estrellas recolectadas", this.cantEstrellas);
  
      this.scene.start("fin", {
        cantEstrellas: this.cantEstrellas,
        y: "este es un dato de muestra",
        z: "este es otro atributo enviado a otro escena",
      });
      this.scene.start("fin", {
        datos: this.cantEstrellas,
      });
    }
